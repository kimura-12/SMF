...
![/Figure1.PNG](https://github.com/kimura-12/SMF/blob/master/assets/Figure1.PNG "図(1)")  
...
![/Figure2.PNG](https://github.com/kimura-12/SMF/blob/master/assets/Figure2.PNG "図(2)")  
<div style="text-align: center;">
図(2) : システム導入による効果  
</div>
